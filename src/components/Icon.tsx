...
const PATHS: Record<IconName, JSX.Element> = {
  ...
  gif: (
    <>
      ...
      <path d="M10 10.5a2 2 0 0 0-3.5 1.5A2 2 0 0 0 10 13.5V12H8.7" />
      <path d="M12.5 10v4" />
      <path d="M15.5 14v-4h2.8M15.5 12.2h2.2" />
    </>
  ),
  ...
  football: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="m12 8 3.4 2.5-1.3 4h-4.2l-1.3-4z" />
      <path d="M12 3v5M20.5 10l-5 .5M17 20l-2.9-3.5M7 20l2.9-3.5M3.5 10l5 .5" />
    </>
  ),
